...
%>
                    <tr>
                      ...
                      <td style="width: 15%;">
                          <!--HINDI PA WORKING -->
                           <div>
                               <a href=""> <button type="button" class="btn btn-default btn-xs btn-filter"><span style="color: green;" class="fas fa-user-check"></span></button></a>
                            <a href=""> <button type="button" class="btn btn-default btn-xs btn-filter"><span style="color: red;" class="fas fa-user-lock"></span></button></a>
                          </div>
                      </td>
                    </tr>
<%
