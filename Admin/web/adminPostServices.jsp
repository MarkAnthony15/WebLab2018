                ...
                <form style="margin-right: 50%;">
                    <div class="card mb-3">
                        ...
                        <div class="form-group" style="margin-left: 5%; margin-right: 5%;">
                            ...
                            <input type="number"  min="100.00" maximum="100,000.00" step="1.50" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control" id="price" />
                            <br>
                            ...
                            <br>
                            <br>
                            <input type="submit" name="" id="singlebutton">
                        </div>
                    </div>  
                </form>
            </div>
