        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <%
              ...
              if (resultSet.next()){
            %>
                  <div class="mr-5"><%=resultSet.getString("COUNT(*)")%> New Users!</div>
            <%
              }
              connection.close();
              } catch (Exception e) {
            ...
            <%
              ...
              if (resultSet.next()){
            %>
                  <div class="mr-5"><%=resultSet.getString("COUNT(*)")%> New Transaction!</div>
            <%
              }
              connection.close();
              } catch (Exception e) {
              ...
              %>
                ...
                <a class="card-footer text-white clearfix small z-1" href="adminUpcomingTransaction.jsp"><!-- HREF-->
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
            ...
            <%
              ...
              %>
                ...
                <a class="card-footer text-white clearfix small z-1" href="InProgressTransaction.jsp"><!-- HREF-->
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
            ...
            <%
              ...
              %>
                ...
                <a class="card-footer text-white clearfix small z-1" href="TerminatedTransaction.jsp"><!-- HREF-->
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
