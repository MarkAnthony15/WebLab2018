...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2018 at 01:43 PM
...
--
-- Database: `weblove_atttirerentals`
--
...
CREATE TABLE `administrator` (
  ...
  `status` enum('Approved','Pending','Disabled','Denied') NOT NULL DEFAULT 'Pending'
...
INSERT INTO `administrator` (`admin_id`, `username`, `password`, `firstname`, `lastname`, `role`, `status`) VALUES
(1, 'superadmin', 'superadmin', 'Super', 'Admin', 'superadmin', 'Approved'),
(2, 'arnel', '123arnel', 'arnel', 'arnel', 'admin', 'Approved');
...
INSERT INTO `client` (`client_id`, `username`, `password`, `email`, `firstname`, `lastname`, `phone_number`, `address_line`, `city`, `province`, `postal_code`, `registration_date`, `status`) VALUES
(27, 'justine', '12345678', 'test@test.com', 'justine ray', 'dungan', '09999999', 'bakakeng', 'baguio', 'benguet', '2600', '2018-11-26 11:19:59', 'Disabled'),
(28, 'mark', '123123', 'mark@gmail.com', 'mark', 'bambico', '09324129304', 'asdwqeasd', 'asdqweasd', 'asdqweqw', '2600', '2018-11-29 16:55:48', 'Denied');

-- --------------------------------------------------------

--
-- Table structure for table `deniedclientlog`
--

CREATE TABLE `deniedclientlog` (
  `id` int(11) NOT NULL,
...
INSERT INTO `trans` (`reservation_number`, `reservation_date`, `pickup_date`, `product_code`, `client_id`, `serviceprov_id`, `status`) VALUES
(221, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 19, 1, 1, 'pending'),
(222, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 20, 1, 1, 'cancelled'),
(223, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 21, 1, 1, 'cancelled'),
(224, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, 1, 'pending'),
(225, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 21, 1, 1, 'pending');
...
--
-- Indexes for table `deniedclientlog`
--
ALTER TABLE `deniedclientlog`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `deniedclientlog`
--
ALTER TABLE `deniedclientlog`
...
--
ALTER TABLE `trans`
  MODIFY `reservation_number` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=226;
